...
const TrustCTASection = ({ title, subtitle, buttonText, buttonLink }) => {
  return (
    <section className="bg-[#ff4422] relative text-white px-6 py-14">
      <div className="absolute top-0 left-0 w-full h-full bg-no-repeat bg-cover opacity-10 pointer-events-none"
        style={{
