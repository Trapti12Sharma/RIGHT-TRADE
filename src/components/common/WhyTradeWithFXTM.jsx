...
import { Scale, GlobeLock, TrendingUp, BookOpen } from "lucide-react"; // Replace or customize as needed

const features = [
  {
    icon: <Scale size={40} strokeWidth={2} className="text-[#FABF16] mb-4" />,
  ...
  {
    icon: (
      <GlobeLock size={40} strokeWidth={2} className="text-[#FABF16] mb-4" />
    ),
  ...
  {
    icon: (
      <TrendingUp size={40} strokeWidth={2} className="text-[#FABF16] mb-4" />
    ),
    title: "Performance",
    description:
  ...
  {
    icon: (
      <BookOpen size={40} strokeWidth={2} className="text-[#FABF16] mb-4" />
    ),
    title: "Access",
    description:
  ...
  return (
    <section className="bg-[#1d203d] text-white py-16 px-6 sm:px-10 md:px-20 text-center">
      <h2 className="text-2xl md:text-3xl font-semibold mb-10">
        Why trade with RightTrade Capital?
      </h2>
