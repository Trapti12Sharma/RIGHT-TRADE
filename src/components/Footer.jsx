          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div>
              ...
              <ul className="space-y-1 sm:space-y-2 text-xs sm:text-sm">
                ...
                <li className="hover:text-gray-300 cursor-pointer transition-colors">FXTM in Nigeria</li>
                <li className="hover:text-gray-300 cursor-pointer transition-colors">FXTM Partnership - Affiliates</li>
      ...
      >
        ...
        >
          ...
          <p className="text-xs sm:text-sm leading-relaxed">
            <strong>Exinity Limited</strong> (www.fxtm.com) with registration number C119470 C1/GBL and registration
          ...
          <p className="text-xs sm:text-sm leading-relaxed">
            <strong>Exinity Capital East Africa Ltd</strong> (www.fxtm.com) with registration number PVT-ZQU6JE7 and
          ...
          <p className="text-xs sm:text-sm leading-relaxed">
            <strong>Exinity UK Limited</strong> (www.forextime.com/uk) with registration number 10599136 and
          ...
          <p className="text-xs sm:text-sm leading-relaxed">
            ...
            East Africa Ltd based on the legal requirements in their country of residence. Please read FXTM's full{" "}
            <span className="text-blue-400 underline cursor-pointer hover:text-blue-300 transition-colors">
              Risk Disclosure
            </span>
            .
          ...
          <p className="mt-4 text-xs sm:text-sm">© 2011 - 2025 FXTM</p>
