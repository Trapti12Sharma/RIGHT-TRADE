...
const CFDOnIndices = () => {
  ...
  // ✅ Third section data (Why Trade CFD on Indices)
  ...
  const videoData = {
    ...
    title: "What is CFD on Indices?",
    description:
      "CFD on Indices (or FX) means Foreign Exchange, the place where currencies are traded. To learn more, check out our complete guide to",
    linkText: "CFD on Indices trading for beginners.",
  ...
  const faqItems = [
    {
      question:
        "How much do I need to start trading CFD on Indices with RightTrade Capital?",
      answer:
    ...
    {
      question: "Which account type is best for trading CFD on Indices?",
      answer:
    ...
    {
      question: "Is CFD on Indices trading safe?",
      answer:
        "CFD on Indices trading involves risks. It is important to trade with a regulated broker and have a solid risk management plan in place.",
    },
    {
  ...
  return (
    <div className="w-full">
      ...
      {/*  2 Section */}
      <ForexTradeSection
        title={CFDOnIndicesContent.title}
        description={CFDOnIndicesContent.description}
        benefits={CFDOnIndicesContent.benefits}
      />
      {/*  3 Section */}
      <WhyTradeForexSection
        title="Why trade CFD on Indices currency pairs with RightTrade Capital?"
