...
import { FaBalanceScale, FaGlobe, FaSearch, FaUniversity } from "react-icons/fa"; // for icons
    ...
    <>
      ...
      >
        ...
        <div className="relative z-20 px-6 sm:px-10 lg:px-20 text-white max-w-3xl text-left">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">Our Global Awards</h2>
      ...
      >
        ...
        <div className="text-sm text-gray-700 mb-8 flex flex-wrap justify-center gap-2">
          <span className="text-[#3B82F6]">FXTM</span>
        ...
        <div className="max-w-4xl mx-auto space-y-4 text-[16px] md:text-[17px] leading-relaxed text-[#212529]">
          <p>
            Over the past 10 years, we've been proud to accept many global awards from some of the most prestigious
            bodies in the business.
          </p>
          <p>
            We do it for you, not the glory - but when you're as committed to your customers as we are, the awards keep
            coming in.
          </p>
          <p>
            Join us today to trade with a broker that prioritises your trading experience above anything else.
          </p>
        </div>
      </section>
        ...
        <section className="bg-[#f9f9f9] py-10 px-4" style={{ fontFamily: '"Source Sans Pro", sans-serif' }}>
        <h2 className="text-center text-[#e74728] text-xl font-bold mb-8 uppercase">Awards</h2>
        ...
        <div className="mt-8 bg-white shadow-md rounded-lg max-w-4xl mx-auto p-10 text-center">
          {selectedYear === "2025" ? (
            ...
            <p className="text-gray-500">No award data available for {selectedYear}</p>
          )}
        </div>
      </section>
...
<section className="bg-[#1a1d30] text-white py-16 px-4">
  ...
  <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 text-center">
    <div>
      ...
      <p className="text-sm">Take advantage of super-low commission rates and spreads from zero</p>
    </div>
    <div>
      <FaGlobe className="text-[#ff4c1b] text-4xl mb-4 mx-auto" />
      <h3 className="font-bold mb-2">Rapid execution speeds</h3>
      <p className="text-sm">Trade execution in milliseconds means you'll always get the best market price</p>
    </div>
    <div>
      <FaSearch className="text-[#ff4c1b] text-4xl mb-4 mx-auto" />
      <h3 className="font-bold mb-2">The world's most popular platform</h3>
      <p className="text-sm">
        Free to download and available on PC, Mac, mobile and tablet to suit you.
      </p>
    </div>
    <div>
...
>
  <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-10">
    ...
    <div className="max-w-xl text-left">
      ...
      <p className="text-sm">
        Already on board? Log back into MyFXTM to check on your accounts or make transactions.
      </p>
    </div>
