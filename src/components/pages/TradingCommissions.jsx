...
const TradingCommissions = () => {
  ...
  const heading = "Before you make that first trade, you’ll want to know how much will it cost you.";
  const description = "We’re proud to offer great pricing and we’re honest about the fees we charge. Have a read through the below and let us know if anything isn’t clear.";
...
You’ll pay that interest to us – but we keep these fees as low as possible."
  ...
  rightText={
    <>
      Our <strong>Advantage account</strong> offers competitive commissions across FX, Spot Metals and Cryptocurrency CFDs. To find out more check out our Help Centre article on{' '}
  ...
  stats={[
    {
      value: "0.0",
      label: "SPREADS",
      description: "Spreads close to zero on major FX pairs, including EURUSD and USDJPY, and as low as zero on XAUUSD.",
    },
    {
      value: "$3.5",
...
/>
     {/*  9th Section - Get more from the markets */}
      ...
      {/*  10th Section */}
     <HelpSupportSection title="Frequently Asked Questions" faqs={tradingFaqs} />
