...
const ContractSpecifications = () => {
  ...
  const faqItems = [
  {
    ...
    answer: "A market is a place where buyers and sellers interact to trade financial instruments such as stocks, forex, commodities, etc.",
  },
  {
    question: "What are trading times?",
    answer: "Trading times refer to the hours during which trading is allowed on specific markets or exchanges. Forex is typically open 24 hours a day during weekdays.",
  },
  {
    question: "What is a 'ticker'?",
    answer: "A ticker is a unique symbol assigned to a traded asset. It helps traders and investors identify and track financial instruments.",
  },
  {
    question: "What's a swap?",
    answer: "A swap is the interest paid or earned for holding a position overnight in trading. It can be positive or negative depending on the interest rate differential between the currencies.",
  },
  {
    question: "What is a minimum spread?",
    answer: "Minimum spread is the lowest possible difference between the bid and ask price of a trading instrument offered by a broker.",
  },
  {
    question: "What is Pip value?",
    answer: "Pip value is the monetary worth of a one-pip movement in a forex trade. It helps determine how much profit or loss will be made per pip movement.",
  },
  {
    question: "What are lot sizes?",
    answer: "Lot sizes refer to the volume or quantity of a trade. In forex, 1 standard lot equals 100,000 units of the base currency.",
  },
  {
  ...
  const statsData = {
    ...
    subtitle: "See our minimum spreads, pip values, swap fees and other conditions.",
