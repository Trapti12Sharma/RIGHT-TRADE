...
const DepositsWithdrawals = () => {
    ...
    const withdrawSteps = [
    "Log in to MyFXTM and open the Withdraw page under ‘My Money’.",
    "Choose your payment method and click ‘Withdraw’.",
    "Choose the MyFXTM account or wallet you wish to withdraw funds from",
    "Complete the necessary fields and click 'Submit.'"
  ];
    const steps = [
    { number: 1, description: "Open the Deposits page within the 'My Money' section in MyFXTM." },
  ...
  const faqs = [
    "What payment methods do FXTM support?",
    "What countries do you support payment methods in?",
    "What are the minimum and maximum deposit amounts for FXTM?",
    "What are the minimum and maximum withdrawal amounts from FXTM?",
    "How do you withdraw from FXTM?",
    "Can I make internal transfers between trading accounts within MyFXTM",
